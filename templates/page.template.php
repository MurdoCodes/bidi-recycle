				...
				<div class="user-details default-container-border">
					...
					<div class="content">
							...
							<div class="form-group">
						    	...
						    	<input type="text" class="form-control" name="from_firstname" value="<?php echo $orderDetails->get_billing_first_name(); ?>" placeholder="<?php echo $orderDetails->get_shipping_first_name(); ?>" readonly>
						  	</div>

						  	<div class="form-group">
						    	<label for="lastName">Last Name:</label>
						    	<input type="text" class="form-control" name="from_lastName" value="<?php echo $orderDetails->get_billing_last_name(); ?>" placeholder="<?php echo $orderDetails->get_shipping_last_name(); ?>" readonly>
						  	</div>
							...
							<div class="form-group">
						    	...
						    	<input type="text" class="form-control" name="from_address" value="<?php echo $orderDetails->get_billing_address_1(); ?>" placeholder="<?php echo $orderDetails->get_shipping_address_1(); ?>" readonly>
						  	</div>


						  	<div class="form-group">
						    	<label for="note">Phone :</label>
						    	<input type="text" class="form-control" name="from_phone_number" value="<?php echo $orderDetails->get_billing_phone(); ?>" placeholder="<?php echo $orderDetails->get_billing_phone(); ?>" readonly>
						  	</div>

						  	<div class="form-group">
						    	<label for="country">Country:</label>
						    	<input type="text" class="form-control" name="from_country" value="<?php echo $orderDetails->get_billing_country(); ?>" placeholder="<?php echo $orderDetails->get_shipping_country(); ?>" readonly>
						  	</div>

						  	<div class="form-group">
						    	<label for="postcode">Postcode:</label>
						    	<input type="text" class="form-control" name="from_postcode" value="<?php echo $orderDetails->get_billing_postcode(); ?>" placeholder="<?php echo $orderDetails->get_shipping_postcode(); ?>" readonly>
						  	</div>

						  	<div class="form-group">
						    	<label for="city">City:</label>
						    	<input type="text" class="form-control" name="from_city" value="<?php echo $orderDetails->get_billing_city(); ?>" placeholder="<?php echo $orderDetails->get_shipping_city(); ?>" readonly>
						  	</div>

						  	<div class="form-group">
						    	<label for="state">State:</label>
						    	<input type="text" class="form-control" name="from_state" value="<?php echo $orderDetails->get_billing_state(); ?>" placeholder="<?php echo $orderDetails->get_shipping_state(); ?>" readonly>
						  	</div>
