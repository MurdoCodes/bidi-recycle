...
class Activate {
	...
	private static function createBidiRecycleTransaction(){
		global $wpdb;
		$bidi_recycle_transaction = $wpdb->prefix . 'bidi_recycle_transaction';

		$charset_collate = $wpdb->get_charset_collate();
		if($wpdb->get_var( "show tables like '$bidi_recycle_transaction'" ) != $bidi_recycle_transaction ){

			$sql = "CREATE TABLE {$bidi_recycle_transaction} (
						transaction_id INT(11) NOT NULL AUTO_INCREMENT,
						transaction_date DATETIME DEFAULT '0000-00-00 00:00:00' NOT NULL,
						transaction_store TEXT NOT NULL,
						transaction_item_qty INT(11) NOT NULL,						
						transaction_tracking_number VARCHAR(100) NOT NULL,
						transaction_image_url VARCHAR(100) NOT NULL,						
