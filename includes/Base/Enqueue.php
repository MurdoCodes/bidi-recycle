...
class Enqueue extends BaseController{
	...
	public function register() {
		...
		$bidiRecyclePage = strpos( $request_uri, '/bidi-recycle/' );

		if( false === $bidiRecyclePage ){
			return false;
		}else{
	...
	public function enqueuePage(){
		...
		wp_enqueue_style( 'bootstrap-min-css', $this->plugin_url . 'assets/css/bootstrap.min.css', __FILE__ );
		wp_enqueue_style( 'bootstrap-select-css', $this->plugin_url . 'assets/css/bootstrap-select.css', __FILE__ );
		...
		wp_enqueue_script( 'bootstrap-min-js', $this->plugin_url . 'assets/js/bootstrap.min.js', __FILE__ );
		wp_enqueue_script( 'bootstrap-select-js', $this->plugin_url . 'assets/js/bootstrap-select.js', __FILE__ );
		wp_enqueue_script( 'nicescroll-js', $this->plugin_url . 'assets/js/jquery.nicescroll.min.js', __FILE__ );
		wp_enqueue_script( 'JqueryConfirmCSSJS', $this->plugin_url . 'assets/js/jquery-confirm.min.js', __FILE__ );
